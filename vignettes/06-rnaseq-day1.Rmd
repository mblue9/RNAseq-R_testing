...
# (PART) RNA-seq analysis {.unnumbered}
...
```{r echo=FALSE}
knitr::include_url("https://docs.google.com/gview?url=https://raw.githubusercontent.com/mblue9/RNAseq-R_testing/master/slides/RNASeq_basics.pdf&embedded=true")
```
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenges_all/)
...
```{r echo=FALSE}
knitr::include_url("https://docs.google.com/gview?url=https://raw.githubusercontent.com/mblue9/RNAseq-R_testing/master/slides/RNASeq_filtering_qc.pdf&embedded=true")
```
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge1/)
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge2/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge3/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge4/)
...
```{r echo=FALSE}
knitr::include_url("https://docs.google.com/gview?url=https://raw.githubusercontent.com/mblue9/RNAseq-R_testing/master/slides/Differential_Expression_Analysis.pdf&embedded=true")
```
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge5/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge6/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge7/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge8/)
...
```{r include=FALSE}
# copy files needed to display Glimma in book
dir.create("../_book")
file.copy('vignettes/mds', '_book', recursive=TRUE, overwrite =TRUE)
file.copy('vignettes/md', '_book', recursive=TRUE, overwrite =TRUE)
file.copy('vignettes/volcano', '_book', recursive=TRUE, overwrite =TRUE)
```
...
```{r echo=FALSE}
knitr::include_url("https://docs.google.com/gview?url=https://raw.githubusercontent.com/mblue9/RNAseq-R_testing/master/slides/Gene_set_testing.pdf&embedded=true")
```
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge9/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge10/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge11/)
...
Try the challenge interactively. Right-click on the launch button below and open in a new tab. May take a minute to launch.  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mblue9/RNAseq-R_learnr_binder/HEAD?urlpath=shiny/challenge12/)
