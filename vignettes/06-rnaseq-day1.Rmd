...
<div class="responsive-container-learnr">
  <iframe id="learnr_iframe"
    src="https://hub.gke2.mybinder.org/user/mblue9-learnr_apps_binder-dxp91qhr/shiny/RNAseq-R/?token=KEMjWoHVR1iUWJBV0Jn-6A" 
    gesture="media"  allowfullscreen
    scrolling="yes">
  </iframe>
</div>
<script>
  iFrameResize({ checkOrigin: 'https://hub.gke2.mybinder.org' , log: false }, '#learnr_iframe')
</script>
