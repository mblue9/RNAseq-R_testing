...
We will show you how to import the files into R from the links. Alternatively you could download them and place them in your working directory (e.g. into a folder called `data` and then refer to them with `data/filename`).
...
[It’s DE-licious:
a recipe for differential expression analyses of RNA-seq
experiments using quasi-likelihood methods in edgeR](http://www.statsci.org/smyth/pubs/QLedgeRPreprint.pdf) [@Lun2016]  [RNAseq data analysis in R](http://monashbioinformaticsplatform.github.io/RNAseq-DE-analysis-with-R/RNAseq_DE_analysis_with_R.html)
...
BiocManager::install(c("limma", "edgeR", "Glimma", "org.Mm.eg.db", "GO.db", "gplots", "RColorBrewer", "NMF"))
```
...
<iframe src="https://raw.githubusercontent.com/mblue9/RNAseq-R/gh-pages/mds/MDS-Plot.html" width="100%" height="1000"></iframe>
...
<iframe src="https://raw.githubusercontent.com/mblue9/RNAseq-R/gh-pages/volcano/XY-Plot.html" width="100%" height="1000"></iframe>
...
<iframe src="https://raw.githubusercontent.com/mblue9/RNAseq-R/gh-pages/md/MD-Plot.html" width="100%" height="1000"></iframe>
...
Mm.c2 <- readRDS("http://bioinf.wehi.edu.au/MSigDB/v7.1/Mm.c2.all.v7.1.entrez.rds")
...
<summary>**Solution**</summary>
```{r, echo=FALSE}
Mm.H <- readRDS("http://bioinf.wehi.edu.au/MSigDB/v7.1/Mm.h.all.v7.1.entrez.rds")
