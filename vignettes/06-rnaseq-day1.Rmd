...
You can see the slides covering RNA-seq basics [here](articles/slides-01-rnaseq-basics.html).
...
You can see the slides covering filtering and quality control [here](articles/slides-02-rnaseq-filtering-qc.html).
...
Try this challenge interactively. Right-click on the launch button below and open in a new tab. Takes a few seconds to launch.  
...
You can see the slides covering differential expression analysis [here](articles/slides-03-differential-expression-analysis.html).
...
You can see the slides covering gene set testing [here](articles/slides-04-gene-set-testing.html).
