...
Here we cover some R skills that are particularly useful for RNAseq analysis, for example data frame manipulation, factors and subsetting using logical statements. If you are a more advanced R user, you may not need this.
...
<object data="../slides/RNASeq_basics.pdf" type="application/pdf" width="700px" height="700px">
...
*It is recommended to store your data in a `/data` folder in your project. However in this workshop we will also show you how you can import the data files directly from links.*
