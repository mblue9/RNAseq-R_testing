...
In this section we cover some R skills that are particularly useful for RNA-seq analysis, for example data frame manipulation, factors and subsetting using logical statements. If you are a more advanced R user, you may not need this.
